...
" ---------------------------------------------------------------------
" First, the Normal
hi Normal        guifg=#e5e5e5 guibg=#131213 gui=NONE
" ---------------------------------------------------------------------
" The Languages stuff
...
hi Constant      guifg=#bfe6aa guibg=NONE    gui=NONE
hi String        guifg=#60bdf4 guibg=NONE    gui=NONE
hi Character     guifg=#ff8da1 guibg=NONE    gui=NONE
hi Number        guifg=#bfe6aa guibg=NONE    gui=NONE
hi Boolean       guifg=#bfe6aa guibg=NONE    gui=NONE
hi Float         guifg=#bfe6aa guibg=NONE    gui=NONE
" ---------------------------------------------------------------------
...
hi VertSplit     guifg=#131213 guibg=#474747 gui=NONE
...
hi SignColumn    guifg=NONE    guibg=#131213 gui=NONE
" }}}
"
" Language Specifics: {{{
" ---------------------------------------------------------------------
...
"
hi SignifySignAdd    guifg=#00ff00 guibg=#131213 gui=NONE
hi SignifySignChange guifg=#ff5f00 guibg=#131213 gui=NONE
hi SignifySignDelete guifg=#ff0000 guibg=#131213 gui=NONE
"
" ---------------------------------------------------------------------
" }}}
"
